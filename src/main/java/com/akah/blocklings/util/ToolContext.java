...
public class ToolContext
{
     ...
     * The type of tool.
     */
    public final com.akah.blocklings.util.ToolType toolType;
     ...
     */
    public ToolContext(@Nonnull com.akah.blocklings.util.ToolType toolType, @Nonnull LivingEntity entity)
    {
     ...
     */
    public ToolContext(@Nonnull com.akah.blocklings.util.ToolType toolType, @Nonnull BlockState blockState)
    {
     ...
     * @param blockState the target block state (should be set if tool type is not a weapon).
     */
    private ToolContext(@Nonnull com.akah.blocklings.util.ToolType toolType, @Nullable LivingEntity entity, @Nullable BlockState blockState)
    {
