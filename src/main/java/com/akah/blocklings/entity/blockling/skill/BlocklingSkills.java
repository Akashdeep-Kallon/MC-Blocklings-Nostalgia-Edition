...
import com.akah.blocklings.entity.blockling.skill.info.SkillGroupInfo;
...
public class BlocklingSkills implements IReadWriteNBT
{
    ...
    {
        @Nonnull public static final SkillGroupInfo GENERAL = new SkillGroupInfo("cf5f4d12-03c1-475c-a4a6-fee8484e8ec4", "general", new BlocklingsResourceLocation("textures/gui/skills_backgrounds/general.png"));
        @Nonnull public static final SkillGroupInfo COMBAT = new SkillGroupInfo("adfab53d-03e7-47e1-8dbe-cf40ee597045", "combat", new BlocklingsResourceLocation("textures/gui/skills_backgrounds/combat.png"));
        @Nonnull public static final SkillGroupInfo MINING = new SkillGroupInfo("c28f70f5-e775-489f-ba08-5d53d1e4200f", "mining", new BlocklingsResourceLocation("textures/gui/skills_backgrounds/mining.png"));
        @Nonnull public static final SkillGroupInfo WOODCUTTING = new SkillGroupInfo("2297bd04-0ea9-401f-a690-9774a9785f75", "woodcutting", new BlocklingsResourceLocation("textures/gui/skills_backgrounds/woodcutting.png"));
        @Nonnull public static final SkillGroupInfo FARMING = new SkillGroupInfo("e71f5788-1a88-41df-8311-c397d5174d51", "farming", new BlocklingsResourceLocation("textures/gui/skills_backgrounds/farming.png"));
    }
    ...
    public void tick()
    {
        for (SkillGroup skillGroup : skillGroups)
        {
            for (Skill skill : skillGroup.getSkills())
            {
                ...
                // [audit-1.20.1] motivo: elimina Stream/lambda en ruta de tick para reducir asignaciones por entidad.
    ...
    public SkillGroup findGroup(@Nonnull SkillInfo skillInfo)
    {
        for (SkillGroup skillGroup : skillGroups)
        {
            for (Skill skill : skillGroup.getSkills())
            {
                if (skill.info == skillInfo)
                {
                    // [audit-1.20.1] motivo: elimina streams anidados y Optional#get() para mejorar robustez y legibilidad.
                    return skillGroup;
                }
            }
        }

        throw new IllegalArgumentException("No skill group found for skill info: " + skillInfo.id);
    }
    ...
    public SkillGroup getGroup(@Nonnull UUID groupId)
    {
        for (SkillGroup skillGroup : skillGroups)
        {
            if (skillGroup.info.id.equals(groupId))
            {
                // [audit-1.20.1] motivo: evita Optional#get() sin contexto y reduce overhead de Stream.
                return skillGroup;
            }
        }

        throw new IllegalArgumentException("No skill group found for id: " + groupId);
    }
