...
import com.akah.blocklings.entity.blockling.skill.skills.WoodcuttingSkills;
import com.akah.blocklings.entity.blockling.task.BlocklingTasks;
import com.akah.blocklings.entity.blockling.task.config.range.FloatRangeProperty;
...
public class BlocklingWoodcutGoal extends BlocklingGatherGoal
{
    ...
    public BlocklingWoodcutGoal(@Nonnull UUID id, @Nonnull BlocklingEntity blockling, @Nonnull BlocklingTasks tasks)
    {
        ...
        BlockUtil.TREES.get().forEach(tree -> logWhitelist.put(BuiltInRegistries.BLOCK.getKey(tree.log), true));
