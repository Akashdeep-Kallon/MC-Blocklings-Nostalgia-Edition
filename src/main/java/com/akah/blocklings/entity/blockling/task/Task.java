...
import com.akah.blocklings.network.messages.TaskCustomNameMessage;
import com.akah.blocklings.network.messages.TaskPriorityMessage;
import com.akah.blocklings.network.messages.TaskSwapPriorityMessage;
import com.akah.blocklings.network.messages.TaskTypeMessage;
...
public class Task
{
    ...
    public void setType(@Nonnull TaskType type, boolean sync)
    {
        ...
        // [final-release-1.20.1] motivo: evita duplicar tipo al cambiar una tarea existente desde el combobox.
        if (type != BlocklingTasks.NULL && tasks.hasTaskOfType(type, id))
        {
            return;
        }
