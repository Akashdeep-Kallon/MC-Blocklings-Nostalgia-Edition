package com.akah.blocklings.entity.blockling.goal.goals.gather;

import com.akah.blocklings.entity.blockling.BlocklingEntity;
import com.akah.blocklings.entity.blockling.BlocklingHand;
import com.akah.blocklings.entity.blockling.skill.skills.FarmingSkills;
...
public class BlocklingFarmGoal extends BlocklingGatherGoal
{
    ...
    public BlocklingFarmGoal(@Nonnull UUID id, @Nonnull BlocklingEntity blockling, @Nonnull BlocklingTasks tasks)
    {
        ...
        BlockUtil.CROPS.get().forEach(crop -> cropWhitelist.put(BuiltInRegistries.BLOCK.getKey(crop), true));
        ...
        BlockUtil.CROPS.get().forEach(crop ->
        {
            ...
            {
                Item seedWhitelistItem = Item.byBlock(crop);
                seedWhitelist.put(BuiltInRegistries.ITEM.getKey(seedWhitelistItem), true);
            }
        });
