package com.akah.blocklings.config;
...
import com.akah.blocklings.util.WorldUtil;
...
public class BlocklingsConfig
{
    ...
    {
        ModContainer activeContainer = ModList.get().getModContainerById(Blocklings.MODID)
                .orElseThrow(() -> new IllegalStateException("Unable to find mod container for " + Blocklings.MODID));
