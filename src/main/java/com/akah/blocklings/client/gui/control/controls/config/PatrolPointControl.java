...
import com.akah.blocklings.client.gui.control.controls.IntFieldControl;
...
import com.akah.blocklings.client.gui.control.event.events.TryDragEvent;
...
public class PatrolPointControl extends Control
{
    ...
    {
        event.setCanceled(handlePatrolPointSelect(event.getEntity(), event.getHand() == InteractionHand.OFF_HAND, event.getPos()));
    }
    ...
    {
        event.setCanceled(handlePatrolPointSelect(event.getEntity(), true, null));
    }
    ...
    {
        handlePatrolPointSelect(event.getEntity(), true, null);
    }
}
