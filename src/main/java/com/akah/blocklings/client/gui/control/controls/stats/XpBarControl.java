package com.akah.blocklings.client.gui.control.controls.stats;
...
public class XpBarControl extends Control
{
     ...
     */
    public XpBarControl(@Nonnull BlocklingEntity blockling, @Nonnull BlocklingAttributes.Level targetLevel)
    {
        super();
        ...
        TexturedControl xpBarBackgroundControl = new TexturedControl(targetLevel.getXpBarBackgroundTexture());
        xpBarBackgroundControl.setParent(xpBarControl);

        TexturedControl xpBarForegroundControl = new TexturedControl(targetLevel.getXpBarForegroundTexture())
        {
            @Override
            public void onTick()
            {
        ...
        levelTextControl.setTextColour(targetLevel.getLevelColour().argb());
    ...
    {
        Attribute<Integer> levelAttribute = blockling.getStats().getLevelAttribute(this.level);
        ...
        tooltip.add(Component.literal(ChatFormatting.GRAY + new BlocklingsComponent("gui.current_level", ChatFormatting.WHITE, levelAttribute.getValue()).getString()).getVisualOrderText());
        tooltip.add(Component.literal(ChatFormatting.GRAY + new BlocklingsComponent("gui.xp_required", ChatFormatting.WHITE, blockling.getStats().getLevelXpAttribute(this.level).getValue(), BlocklingAttributes.getXpForLevel(levelAttribute.getValue())).getString()).getVisualOrderText());
